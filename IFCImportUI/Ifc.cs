...
namespace IFCImportUI
{
    class Ifc
    {
        ...
        public Ifc(string path, ref ObservableCollection<Node> nodes, ref int maxLevel,
            ref string volumePropertyName, ref string costPropertyName )
        {
            _volumePropertyName = (volumePropertyName != null && volumePropertyName.Length>0) ? volumePropertyName : null;
            _costPropertyName = (costPropertyName != null && costPropertyName.Length > 0)? costPropertyName : null;
